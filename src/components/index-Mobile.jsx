                    ...
                    <div className="bgImageMb">
                        <header className="header-container">
                            <Link className="jeevansathi-logo--Mobile" to="/">
                                <img height="100%" width="100%"  src="https://static.jeevansathi.com/js_static/_next/static/images/js_logo-fe14652b87cc5a60d9512ac68bc23d9e.svg" alt="image"/>
                            </Link>
                    ...
                    <div className="homeContainer">
                                ...
                                <div>
                                    <div className=" d-flex mt-3">
                                        <div className="imgInfo">
                                            <img width="70px" height="40px" src="https://static.jeevansathi.com/js_static/_next/static/images/Screened_Profiles-63d4c9edff8d96926cbf2d19c392be95.svg" alt="image"/>
                                        </div>
                            ...
                            <div className="featuresSection">
                                        ...
                                        <div className="featuresSection-dflex">
                                            <div className="featuresSection-Card">
                                                <div className="featuresSectionImages pt-5">
                                                    <img width="100%" height="100%" src="https://static.jeevansathi.com/js_static/_next/static/images/match-hour-19b5b6122d30ef883c29f19334394835.svg" alt="image"/>
                                                </div>
                                            ...
                                            <div className="featuresSection-Card">
                                                <div className="featuresSectionImages pt-4">
                                                    <img width="100%" src="https://static.jeevansathi.com/js_static/_next/static/images/Video_Voice-0a41d02f12a4d6ac442d6f89c537443b.svg" alt="image"/>
                                                </div>
                                                <div className="underline3"></div>
                                            ...
                                            <div className="featuresSection-Card">
                                                <div className="featuresSectionImages">
                                                    <img width="100%" src="https://static.jeevansathi.com/js_static/_next/static/images/Video_Profile-c39366134dc7ff2aa86ab7541f555680.svg" alt="image"/>
                                                </div>
                                                <div className="underline3"></div>
                                    ...
                                    <div className="featuresSectionContain">
                                        <div className="featuresSections--lists">
                                            <div className="featuresSectionImg">
                                                <img className="carouselImg" src={findWorkImg1} alt="image"/>
                                                <p><span>01</span> Define Your Partner Preferences</p>
                                            </div>
                                            <div className="featuresSectionImg">
                                                <img className="carouselImg" src={findWorkImg2} alt="image"/>
                                                <p><span>02</span> Browse Profiles</p>
                                            </div>
                                            <div className="featuresSectionImg">
                                                <img className="carouselImg" src={findWorkImg3} alt="image"/>
                                ...
                                <div className="exclusivePad">
                                    ...
                                    <img className="exclusiveImg" src="https://www.jeevansathi.com/images/jspc/commonimg/JS_Exclusive_Image_final_min.png" alt="image"/>         
                                    <div className="exclusiveList">
                                        <ul>  
                                            <li>
                                                <img width="20px" height="20px" src="https://static.jeevansathi.com/images/jsms/photo/Meet_your_advisor.svg" alt="image"/>
                                            ...
                                            <li>
                                                <img width="20px" height="20px" src="https://static.jeevansathi.com/images/jsms/photo/Handpicked.svg" alt="image"/>
                                ...
                                <div>
                                    ...
                                    <div className="">
                                        <img className="connectApp" src="https://static.jeevansathi.com/images/jsms/photo/group_64_new.png" alt="image"/>                                                                                      
                                    </div> 
                                    ...
                                    <div className="connectAppIcon">
                                        <img width="100%" src="https://static.jeevansathi.com/images/jsms/photo/Google%20Play%20Icon.png" alt="image"/>
                                    </div>
                                </div>   
                                ...
                                <div className="seoContain">
                                    <div className="d-flex">
                                        <div className="">
                                            <img width="28px" height="28px" src="https://static.jeevansathi.com/images/jsms/photo/js_footer_logo.png" alt="image"/>
                                        </div>
