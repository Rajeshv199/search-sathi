            ...
            <div className="loginViewMob">
                ...
                <div className="login-header">
                    ...
                    <div className="login-LogoImg">
                        <Link to="/"><img width="100%" src="https://static.jeevansathi.com/js_static/_next/static/images/jeevansathi-icon-450441e73ce54060c3241fe9d389d502.svg" alt="" /></Link>
                    </div>
