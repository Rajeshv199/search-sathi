    ...
    return <div className='success-main'>
        <div className="success-nav" >
            <div className="help-nav-child1">
                <Link to="/"><img src={logo} alt='' className='p-2'/></Link>
            </div>
            ...
            <div className="help-nav-child3"  >
                ...
                <div >
                    <img src={userVector} height={40} width={40} style={{ border: '1px', borderRadius: '50%' }} alt='' />
                </div>
            </div>
        </div>
        ...
        <div >
            <div style={{ zIndex: '-1', backgroundColor: 'white', width: '100%' }}>
                <img src={successBackground} width={'100%'} alt=''/>
            </div>
            ...
            <div className='success-header-content'>
                ...
                <br/><br/>
                <p style={{ fontFamily: "sans-serif Roboto"}}>As our numerous success stories prove, marriages are really made at Yogjodi.com. Here's wishing all our members who found their ideal partner here a lifetime of happiness! If you found your dream match through Yogjodi.com, we would like to hear your success story too. So, just send in your wedding/ engagement photograph and it will be exclusively featured in our "success stories".</p>
                <br/>
