                        ...
                        <div className="firstBlock">
                            ...
                            <div className="homeContainer">
                                ...
                                <div className="seoText">
                                    <div><img src="https://www.jeevansathi.com/images/jspc/commonimg/JSFooterLogo.png" alt=""/></div>    
                    ...
                    <div className="bgImageMb">
                        <header className="header-container">
                            <Link className="jeevansathi-logo--Mobile" to="/">
                                <img height="100%" width="100%"  src="https://static.jeevansathi.com/js_static/_next/static/images/js_logo-fe14652b87cc5a60d9512ac68bc23d9e.svg" alt=""/>
                            </Link>
                    ...
                    <div className="homeContainer">
                            ...
                            <div className="featuresSection">
                                ...
                                <div className="exclusivePad">
                                    ...
                                    <img className="exclusiveImg" src="https://www.jeevansathi.com/images/jspc/commonimg/JS_Exclusive_Image_final_min.png" alt=""/>         
                                    <div className="exclusiveList">
                                        <ul>  
                                            <li>
                                                <img width="20px" height="20px" src="https://static.jeevansathi.com/images/jsms/photo/Meet_your_advisor.svg" alt=""/>
                                            ...
                                            <li>
                                                <img width="20px" height="20px" src="https://static.jeevansathi.com/images/jsms/photo/Handpicked.svg" alt=""/>
                                ...
                                <div>
                                    ...
                                    <div className="">
                                        <img className="connectApp" src="https://static.jeevansathi.com/images/jsms/photo/group_64_new.png" alt=""/>                                                                                      
                                    </div> 
                                    ...
                                    <div className="connectAppIcon">
                                        <img width="100%" src="https://static.jeevansathi.com/images/jsms/photo/Google%20Play%20Icon.png" alt=""/>
                                    </div>
                                </div>   
                                <div className="matrimonialContainer">
                                    <h3 className="m-0">
                                ...
                                <div className="seoContain">
                                    <div className="d-flex">
                                        <div className="">
                                            <img width="28px" height="28px" src="https://static.jeevansathi.com/images/jsms/photo/js_footer_logo.png" alt=""/>
                                        </div>
