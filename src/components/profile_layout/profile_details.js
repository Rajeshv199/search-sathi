        ...
        <div className='profile-detail-body'>
            ...
            <div className="profileDetils">
                ...
                <div className='left-side'>
                    <div className={'left-side-items '+(activeItem==1?"colr5":"")} onClick={()=>setActiveItem(1)}>
                        <h6>Matches</h6>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6" /></svg>
                    </div>
                
                    <div className={'left-side-items '+(activeItem==2?"colr5":"")} onClick={()=>setActiveItem(2)}>
                        <h6>Activity</h6>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right"><path d="m9 18 6-6-6-6" /></svg>
                    </div>
                   ...
                   <div className="custom-Card">
                        ...
                        <div className='d-block w-100'>
                            <Link >
                                <div className='card-text'>
                                    ...
                                    <div className='d-flex'>
                                        ...
                                        <div className='profleHight mxWid50'><span className='mx-2'>•</span>Kumar </div>
                                    </div>
                            ...
                            <div className="connectItem">
                                <button><span class="material-symbols-outlined px-1 dewsd">forward_to_inbox</span>Send Interest</button>
                                <button><i class="fa-regular fa-star px-1"></i>Shortlist</button>
                                <button><i class="fa-regular fa-comment px-1"></i>Chat</button>
                            </div>
                        </div>
